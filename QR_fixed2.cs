...
// - ABCD shield X markers (Draw.Text "X" because Draw.Cross is not available in some NT builds)
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class QR : Indicator
	{
		...
		protected override void OnBarUpdate()
		{
			...
			// -------------------------
			// TV-style 20-80 zone fill (rectangle spanning loaded history)
			// -------------------------
			...
			// Draw Text "X" markers (safe across NT versions)
			if (abcdBull)
				Draw.Text(this, "ABCD_BULL_X_" + CurrentBar, false, "X", 0, 98, Brushes.LimeGreen);

			if (abcdBear)
				Draw.Text(this, "ABCD_BEAR_X_" + CurrentBar, false, "X", 0, 2, Brushes.Red);
