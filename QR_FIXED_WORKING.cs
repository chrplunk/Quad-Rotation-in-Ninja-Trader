...
// - ABCD shield "X" markers (Draw.Text overload that exists on older NT builds)
...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class QR : Indicator
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Name = "QR";
				Description = "Quad Rotation - 4 Stochastics Overlay (20–80 fill + zingers + editable colors).";
				IsOverlay = false;
		...
		protected override void OnBarUpdate()
		{
			...
			{
				int startBarsAgo = CurrentBar; // oldest loaded
				int endBarsAgo   = 0;
			...
			if (abcdBull)
				Draw.Text(this, "ABCD_BULL_X_" + CurrentBar, "X", 0, 98, Brushes.LimeGreen);

			if (abcdBear)
				Draw.Text(this, "ABCD_BEAR_X_" + CurrentBar, "X", 0, 2, Brushes.Red);
